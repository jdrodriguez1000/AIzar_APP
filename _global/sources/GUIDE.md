<!-- ==========================================================================
     COPIA INTACTA — NO SE EDITA AQUI
     ========================================================================== -->

> 📌 **Copia intacta de `Edu_TripleS/GUIDE.md`, tomada el 2026-08-28.**
>
> Es la **fuente** de la que se destilo `_global/guide.md`, y se conserva como registro de como
> se destilo — igual que `_methodology/sources/` guarda las fuentes de `000_method.md`.
>
> 🚨 **Aqui no se edita nada.** Si el original cambia y merece la pena, se **retoma el snapshot
> entero** y se anota la linea en `_global/changelog.md`. Editar esta copia la convierte en una
> tercera version que no es ni la fuente ni el destilado.
>
> **Si esta copia y `guide.md` dicen cosas distintas, manda `guide.md`.** El destilado es
> posterior y esta pensado para cualquier proyecto; esta fuente es de un curso concreto, con sus
> cifras medidas en otra maquina y su stack propio.
